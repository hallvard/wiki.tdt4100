...
public class Calc1Test extends TestCase {
  ...
  @JExercise(tests = "void setValue(double)", description = "<h3>Sett verdi</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Sett verdi til et tilfeldig tall: value = random</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void setValue(double);void add(double)", description = "<h3>Addisjon</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Addisjon med to tilfeldige tall: value = random1, add(random2)</li>\n\t\t</ul>\n")
  public void testAdd() {
  ...
  @JExercise(tests = "void setValue(double);void subtract(double)", description = "<h3>Subtraksjon</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Subtraksjon med to tilfeldige tall: value = random1, subtract(random2)</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void setValue(double);void multiply(double)", description = "<h3>Multiplikasjon</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Multiplikasjon med to tilfeldige tall: value = random1, multiply(random2)</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void setValue(double);void divide(double)", description = "<h3>Divisjon</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Divisjon med to tilfeldige tall: value = random1, divide(random2)</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void setValue(double);void percent(double)", description = "<h3>Prosent</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Tilfeldig prosent av et tilfeldige tall: value = random1, percent(random2)</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void setValue(double);void negate()", description = "<h3>Negasjon</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Negasjon av et tilfeldige tall: value = random1, negate</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void pi()", description = "<h3>Pi</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>pi</li>\n\t\t</ul>\n")
  public void testPi() {
