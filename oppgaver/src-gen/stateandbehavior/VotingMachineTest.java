...
public class VotingMachineTest extends TestCase {
  ...
  @JExercise(tests = "void voteDemocrat()", description = "<h3>Demokrat-stemmer</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>2 demokrat-stemmer.: voteDemocrat # votes</li>\n\t\t</ul>\n")
  ...
  @JExercise(tests = "void voteRepublican()", description = "<h3>Replikaner-stemmer</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>3 replikaner-stemmer.: voteRepublican # votes</li>\n\t\t</ul>\n")
