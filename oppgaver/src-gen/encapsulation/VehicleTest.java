...
public class VehicleTest extends TestCase {
  ...
  @JExercise(tests = "null(char,char,String)", description = "<h3>Ugyldig drivstoff</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>vehicle = new Vehicle(\'Y\', \'C\', \"BN12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'H\', \'M\', \"HY1234\")</li>\n\t\t</ul>\n")
  public void testConstructorInvalidFuel() {
    try {
      _transition_exprAction__constructorInvalidFuel_transitions0_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('Y', 'C', \"BN12345\")");
    } catch (Exception e) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('Y', 'C', \"BN12345\")", e instanceof IllegalArgumentException);
    }
    try {
  ...
  public void testConstructorInvalidVehicleType() {
    try {
      ...
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'P', \"BN12345\")");
    } catch (Exception e) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'P', \"BN12345\")", e instanceof IllegalArgumentException);
    }
    
  }
  
  @JExercise(tests = "null(char,char,String)", description = "<h3>Ugyldig registreringsnumber</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"A1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"A12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"AB1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"AB123456\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"ABC1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"A\u00C612345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"ab12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"A1B2345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"A1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"A12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"AB123\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"AB12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"ABC1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"ABC12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"A\u00C51234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"ab1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"EL12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"EK12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'C\', \"HY12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'C\', \"EL12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'C\', \"EK12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'C\', \"HY12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'H\', \'C\', \"EL12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'H\', \'C\', \"EK12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'H\', \'C\', \"BN12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'E\', \'C\', \"HY12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'E\', \'C\', \"BN12345\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"EL1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"EK1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'B\', \'M\', \"HY1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'M\', \"EL1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'M\', \"EK1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'D\', \'M\', \"HY1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'E\', \'M\', \"HY1234\")</li>\n\t\t<li>vehicle = new Vehicle(\'E\', \'M\', \"BN1234\")</li>\n\t\t</ul>\n")
  public void testConstructorInvalidRegistrationNumber() {
    try {
      ...
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A1234\")");
    } catch (Exception e) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A1234\")", e instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions1_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A12345\")");
    } catch (Exception e_1) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A12345\")", e_1 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions2_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AB1234\")");
    } catch (Exception e_2) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AB1234\")", e_2 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions3_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AB123456\")");
    } catch (Exception e_3) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AB123456\")", e_3 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions4_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ABC1234\")");
    } catch (Exception e_4) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ABC1234\")", e_4 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions5_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AÆ12345\")");
    } catch (Exception e_5) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AÆ12345\")", e_5 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions6_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ab12345\")");
    } catch (Exception e_6) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ab12345\")", e_6 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions7_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A1B2345\")");
    } catch (Exception e_7) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"A1B2345\")", e_7 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions8_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"A1234\")");
    } catch (Exception e_8) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"A1234\")", e_8 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions9_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"A12345\")");
    } catch (Exception e_9) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"A12345\")", e_9 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions10_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"AB123\")");
    } catch (Exception e_10) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"AB123\")", e_10 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions11_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"AB12345\")");
    } catch (Exception e_11) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"AB12345\")", e_11 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions12_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"ABC1234\")");
    } catch (Exception e_12) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"ABC1234\")", e_12 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions13_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"ABC12345\")");
    } catch (Exception e_13) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"ABC12345\")", e_13 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions14_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AÅ1234\")");
    } catch (Exception e_14) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"AÅ1234\")", e_14 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions15_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ab1234\")");
    } catch (Exception e_15) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"ab1234\")", e_15 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions16_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"EL12345\")");
    } catch (Exception e_16) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"EL12345\")", e_16 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions17_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"EK12345\")");
    } catch (Exception e_17) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"EK12345\")", e_17 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions18_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"HY12345\")");
    } catch (Exception e_18) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'C', \"HY12345\")", e_18 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions19_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"EL12345\")");
    } catch (Exception e_19) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"EL12345\")", e_19 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions20_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"EK12345\")");
    } catch (Exception e_20) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"EK12345\")", e_20 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions21_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"HY12345\")");
    } catch (Exception e_21) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"HY12345\")", e_21 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions22_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"EL12345\")");
    } catch (Exception e_22) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"EL12345\")", e_22 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions23_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"EK12345\")");
    } catch (Exception e_23) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"EK12345\")", e_23 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions24_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"BN12345\")");
    } catch (Exception e_24) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('H', 'C', \"BN12345\")", e_24 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions25_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'C', \"HY12345\")");
    } catch (Exception e_25) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'C', \"HY12345\")", e_25 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions26_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'C', \"BN12345\")");
    } catch (Exception e_26) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'C', \"BN12345\")", e_26 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions27_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"EL1234\")");
    } catch (Exception e_27) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"EL1234\")", e_27 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions28_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"EK1234\")");
    } catch (Exception e_28) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"EK1234\")", e_28 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions29_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"HY1234\")");
    } catch (Exception e_29) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('B', 'M', \"HY1234\")", e_29 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions30_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"EL1234\")");
    } catch (Exception e_30) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"EL1234\")", e_30 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions31_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"EK1234\")");
    } catch (Exception e_31) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"EK1234\")", e_31 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions32_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"HY1234\")");
    } catch (Exception e_32) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'M', \"HY1234\")", e_32 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions33_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'M', \"HY1234\")");
    } catch (Exception e_33) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'M', \"HY1234\")", e_33 instanceof IllegalArgumentException);
    }
    try {
      _transition_exprAction__constructorInvalidRegistrationNumber_transitions34_actions0(vehicle);
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'M', \"BN1234\")");
    } catch (Exception e_34) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('E', 'M', \"BN1234\")", e_34 instanceof IllegalArgumentException);
    }
    
  }
  
  @JExercise(tests = "null(char,char,String);void setRegistrationNumber(String)", description = "<h3>Endre registreringsnummer p\u00E5 gyldig vis</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>vehicle = new Vehicle(\'D\', \'C\', \"BN12345\"), setRegistrationNumber(\"AB54321\")</li>\n\t\t<li>vehicle = new Vehicle(\'E\', \'M\', \"EK1234\"), setRegistrationNumber(\"EL4321\")</li>\n\t\t</ul>\n")
  ...
  public void testSetRegistrationNumberInvalidUseDoesntChangeState() {
    try {
      ...
      fail("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"BN12345\"), setRegistrationNumber(\"AB654321\")");
    } catch (Exception e) {
      assertTrue("IllegalArgumentException should be thrown after vehicle = new Vehicle('D', 'C', \"BN12345\"), setRegistrationNumber(\"AB654321\")", e instanceof IllegalArgumentException);
    }
  ...
  private void _transition_exprAction__constructorCorrectUse_transitions0_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'C', "BN12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'C', \"BN12345\") failed: " + error.getMessage());
    }
  ...
  private void _test__constructorCorrectUse_transitions0_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    assertEquals("getRegistrationNumber() == \"BN12345\" failed after vehicle = new Vehicle('D', 'C', \"BN12345\")", "BN12345", _registrationNumber);
    
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "D");
    assertTrue("getFuel() == 'D' failed after vehicle = new Vehicle('D', 'C', \"BN12345\")", _equals);
    
    char _vehicleType = it.getVehicleType();
    assertTrue("getVehicleType() == 'C' failed after vehicle = new Vehicle('D', 'C', \"BN12345\")", this.operator_equals(Character.valueOf(_vehicleType), "C"));
  ...
  private void _transition_exprAction__constructorCorrectUse_transitions1_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'M', "EL1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'M', \"EL1234\") failed: " + error.getMessage());
    }
  ...
  private void _test__constructorCorrectUse_transitions1_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    String _registrationNumber = it.getRegistrationNumber();
    assertEquals("getRegistrationNumber() == \"EL1234\" failed after vehicle = new Vehicle('E', 'M', \"EL1234\")", "EL1234", _registrationNumber);
    
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "E");
    assertTrue("getFuel() == 'E' failed after vehicle = new Vehicle('E', 'M', \"EL1234\")", _equals);
    
    char _vehicleType = it.getVehicleType();
    assertTrue("getVehicleType() == 'M' failed after vehicle = new Vehicle('E', 'M', \"EL1234\")", this.operator_equals(Character.valueOf(_vehicleType), "M"));
  ...
  private void _transition_exprAction__constructorInvalidFuel_transitions0_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('Y', 'C', "BN12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('Y', 'C', \"BN12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidFuel_transitions1_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('H', 'M', "HY1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('H', 'M', \"HY1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidVehicleType_transitions0_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'P', "BN12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'P', \"BN12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions0_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "A1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"A1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions1_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "A12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"A12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions2_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "AB1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"AB1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions3_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "AB123456");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"AB123456\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions4_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "ABC1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"ABC1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions5_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "A\u00C612345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"AÆ12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions6_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "ab12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"ab12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions7_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "A1B2345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"A1B2345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions8_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "A1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"A1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions9_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "A12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"A12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions10_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "AB123");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"AB123\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions11_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "AB12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"AB12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions12_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "ABC1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"ABC1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions13_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "ABC12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"ABC12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions14_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "A\u00C51234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"AÅ1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions16_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "EL12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"EL12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions17_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "EK12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"EK12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions18_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'C', "HY12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'C', \"HY12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions19_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'C', "EL12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'C', \"EL12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions20_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'C', "EK12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'C', \"EK12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions21_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'C', "HY12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'C', \"HY12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions22_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('H', 'C', "EL12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('H', 'C', \"EL12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions23_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('H', 'C', "EK12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('H', 'C', \"EK12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions24_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('H', 'C', "BN12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('H', 'C', \"BN12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions25_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'C', "HY12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'C', \"HY12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions26_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'C', "BN12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'C', \"BN12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions27_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "EL1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"EL1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions28_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "EK1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"EK1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions29_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "HY1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"HY1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions30_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'M', "EL1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'M', \"EL1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions31_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'M', "EK1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'M', \"EK1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions32_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'M', "HY1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'M', \"HY1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions33_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'M', "HY1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'M', \"HY1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__constructorInvalidRegistrationNumber_transitions34_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'M', "BN1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'M', \"BN1234\") failed: " + error.getMessage());
    }
  ...
  private void _test__setRegistrationNumberCorrectUse_transitions0_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    String _registrationNumber = it.getRegistrationNumber();
    assertEquals("getRegistrationNumber() == \"AB54321\" failed after vehicle = new Vehicle('D', 'C', \"BN12345\") ,setRegistrationNumber(\"AB54321\")", "AB54321", _registrationNumber);
    
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "D");
    assertTrue("getFuel() == 'D' failed after vehicle = new Vehicle('D', 'C', \"BN12345\") ,setRegistrationNumber(\"AB54321\")", _equals);
    
    char _vehicleType = it.getVehicleType();
    assertTrue("getVehicleType() == 'C' failed after vehicle = new Vehicle('D', 'C', \"BN12345\") ,setRegistrationNumber(\"AB54321\")", this.operator_equals(Character.valueOf(_vehicleType), "C"));
  ...
  private void _transition_exprAction__setRegistrationNumberCorrectUse_transitions1_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'M', "EK1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'M', \"EK1234\") failed: " + error.getMessage());
    }
  ...
  private void _test__setRegistrationNumberCorrectUse_transitions1_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    String _registrationNumber = it.getRegistrationNumber();
    assertEquals("getRegistrationNumber() == \"EL4321\" failed after vehicle = new Vehicle('E', 'M', \"EK1234\") ,setRegistrationNumber(\"EL4321\")", "EL4321", _registrationNumber);
    
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "E");
    assertTrue("getFuel() == 'E' failed after vehicle = new Vehicle('E', 'M', \"EK1234\") ,setRegistrationNumber(\"EL4321\")", _equals);
    
    char _vehicleType = it.getVehicleType();
    assertTrue("getVehicleType() == 'M' failed after vehicle = new Vehicle('E', 'M', \"EK1234\") ,setRegistrationNumber(\"EL4321\")", this.operator_equals(Character.valueOf(_vehicleType), "M"));
  ...
  private void _test__setRegistrationNumberInvalidUseDoesntChangeState_transitions1_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "D");
    assertTrue("getFuel() == 'D' failed", _equals);
  ...
  private void _test__setRegistrationNumberInvalidUseDoesntChangeState_transitions3_effects0_state_objectTests0_test(final Vehicle it) {
    ...
    char _fuel = it.getFuel();
    boolean _equals = this.operator_equals(Character.valueOf(_fuel), "E");
    assertTrue("getFuel() == 'E' failed", _equals);
  ...
  private void _transition_exprAction__setRegistrationNumberInvalidUse_transitions9_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('B', 'M', "AB1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('B', 'M', \"AB1234\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__setRegistrationNumberInvalidUse_transitions22_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'C', "AB12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'C', \"AB12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__setRegistrationNumberInvalidUse_transitions26_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('H', 'C', "HY12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('H', 'C', \"HY12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__setRegistrationNumberInvalidUse_transitions30_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('E', 'C', "EL12345");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('E', 'C', \"EL12345\") failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__setRegistrationNumberInvalidUse_transitions37_actions0(final Vehicle it) {
    try {
      ...
      Vehicle _vehicle = new Vehicle('D', 'M', "AB1234");
      this.vehicle = _vehicle;
      } catch (junit.framework.AssertionFailedError error) {
      fail("vehicle = new Vehicle('D', 'M', \"AB1234\") failed: " + error.getMessage());
    }
