...
public class DinerTest extends TestCase {

	private Diner diner;
	private Table table4, table8;
	...
	public void testSplitTable() {
		assertEquals(2, diner.getTableCount());
		assertEquals(12, diner.getCapacity(false));
		diner.splitTable(table8, 6, 4);
		assertEquals(3, diner.getTableCount());
		assertEquals(14, diner.getCapacity(false));
	}
	...
	public void testRemoveSeating() {
		...
		diner.removeSeating(seating1.getTable().getNum());
		assertFalse(diner.isOccupied(table4));
	}
}
