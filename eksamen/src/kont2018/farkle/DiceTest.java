...
public class DiceTest {
	...
	static Dice dice(final Integer... values) {
		return new Dice(Arrays.asList(values));
	}
	...
	public void testIsSame() {
		final Dice dice1 = dice(1, 1, 2, 4, 3);
		final Dice dice2 = dice(1, 1, 2, 4, 3);
		final Dice dice3 = dice(1, 2, 4, 3);
		Assert.assertTrue(dice1.isSame(dice1));
		Assert.assertTrue(dice1.isSame(dice2));
		Assert.assertFalse(dice1.isSame(dice3));
		Assert.assertFalse(dice3.isSame(dice1));
	}
